...
//    @Transactional
//    @Modifying
//    @Query(value = "update movie_category set category_id = :category_id where movie_id = :movieId", nativeQuery = true)
//    void editMovieCategory(@Param("movieId") Integer movieId, @Param("categoryId") Integer categoryId);

//    @Transactional
//    @Modifying
//    @Query(value = "select * form movie_category where movie_id = :movieId", nativeQuery = true)
//    List<MovieCategory> getMovieCategory(@Param("movieId") Integer movieId);
